...
#   Usage: python learning_tensorflow_new.py --device [auto|gpu|cpu]
...
model_savefolder = "./model.keras"  # Use .keras extension for modern TensorFlow


def parse_arguments():
    """Parse command line arguments for device selection."""
    parser = argparse.ArgumentParser(
        description="ViZDoom Deep Q-Network Training with TensorFlow",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Examples:
  python learning_tensorflow_new.py --device gpu
  python learning_tensorflow_new.py --device cpu
  python learning_tensorflow_new.py --device auto
        """
    )
